...
interface Table14Props {}

export const config = {
  title: 'With summary rows'
}

const Table14: FC<Table14Props> = () => {
  return (
          ...
          <tfoot>
            <tr>
              <th
                scope="row"
                colSpan={3}
                className="hidden pt-6 pl-6 pr-3 text-right text-sm font-normal text-gray-500 sm:table-cell md:pl-0"
              >
                Subtotal
              </th>
              <th
                scope="row"
                className="pt-6 pl-4 pr-3 text-left text-sm font-normal text-gray-500 sm:hidden"
              >
                Subtotal
              </th>
            ...
            <tr>
              <th
                scope="row"
                colSpan={3}
                className="hidden pt-4 pl-6 pr-3 text-right text-sm font-normal text-gray-500 sm:table-cell md:pl-0"
              >
                Tax
              </th>
              <th
              ...
              <td className="pt-4 pl-3 pr-4 text-right text-sm text-gray-500 sm:pr-6 md:pr-0">
                $585.00
              </td>
            </tr>
            <tr>
              <th
                scope="row"
                colSpan={3}
                className="hidden pt-4 pl-6 pr-3 text-right text-sm font-semibold text-gray-900 sm:table-cell md:pl-0"
              >
                Total
              </th>
              <th
              ...
              <td className="pt-4 pl-3 pr-4 text-right text-sm font-semibold text-gray-900 sm:pr-6 md:pr-0">
                $4,485.00
              </td>
            </tr>
          </tfoot>
